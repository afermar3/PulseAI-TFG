import 'package:afermar3_tf_ipc/funcionalidad/pantallas/Home/actividad_acabada.dart';
import 'package:afermar3_tf_ipc/funcionalidad/pantallas/Home/actividades.dart';
import 'package:afermar3_tf_ipc/funcionalidad/pantallas/Home/notif.dart';
import 'package:afermar3_tf_ipc/funcionalidad/pantallas/Home/widget_ejercicio.dart';
...
class _Homepantalla extends State<Home> {
  ...
  List agua = [
    {"titulo": "6am - 8am", "subtitulo": "600ml"},
    {"titulo": "9am - 11am", "subtitlo": "500ml"},
    {"titulo": "11am - 2pm", "subtitlo": "1000ml"},
    {"titulo": "2pm - 4pm", "subtitlo": "700ml"},
    {"titulo": "4pm - now", "subtitlo": "900ml"},
  ];
      ...
      LineChartBarData(
        ...
        belowBarData: BarAreaData(
          ...
          gradient: LinearGradient(colors: [
            TColor.primerColor1.withOpacity(0.4),
            TColor.primerColor2.withOpacity(0.1),
            ...
            child: Column(
              ...
              children: [
                    ...
                    IconButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const Notificacion(),
                            ),
                          );
                        },
                        icon: Image.asset(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: TColor.primerColor2.withOpacity(0.3),
                      ...
                      LineChartData(
                              ...
                              return TouchedSpotIndicatorData(
                                ...
                                FlDotData(
                                  ...
                                  getDotPainter:
                                    ...
                                    color: Colors.white,
                                    strokeWidth: 3,
                                    strokeColor: TColor.segundoColor1,
                                  ),
                                ),
                              );
                            }).toList();
                        ...
                        gridData: FlGridData(
                          ...
                          getDrawingHorizontalLine: (value) {
                            return FlLine(
                              color: TColor.negro.withOpacity(0.15),
                              strokeWidth: 2,
                            );
                          },
                        ),
                ...
                ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: ultima_act.length,
                    itemBuilder: (context, index) {
                      var wObj = ultima_act[index] as Map? ?? {};
                      return InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => EjercicioAcabado(),
                              ),
                            );
                          },
  ...
  List<PieChartSectionData> Secciones() {
    return List.generate(
      2,
      (i) {
        var color0 = TColor.segundoColor1;
